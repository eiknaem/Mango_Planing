...
export default function ProjectsearchScreen({ route, navigation }) {
    ...
    const getSearchHistory = async () => {
        try {
            const history = await getDataStorage('Project_history');
            if (history) {
        ...
        Alert.alert(
            ...
            [
                ...
                },
                {
                    ...
                    onPress: async () => {
                        setSearchHistory([]);
                        await setDataStorage('Project_history', JSON.stringify([]));
                    }
                }
            ]
        );
